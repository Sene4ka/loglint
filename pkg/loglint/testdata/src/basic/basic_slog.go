...
func testSlogBasic() {
	...
	slog.Info("user password: " + password) // want "log message should not contain sensitive information" "log variable name suggests sensitive data"
	slog.Debug("api_key=" + apiKey)         // want "log message should not contain sensitive information" "log variable name suggests sensitive data"
	slog.Info("token: " + token)            // want "log message should not contain sensitive information" "log variable name suggests sensitive data"
	slog.Info("user authenticated")         // OK
	slog.Debug("api request completed")     // OK
	slog.Info("token validated")            // OK

	slog.Info("us" + "er pass" + "word: " + password) // want "log message should not contain sensitive information" "log variable name suggests sensitive data"
	slog.Debug("ap" + "i_" + "key=" + apiKey)         // want "log message should not contain sensitive information" "log variable name suggests sensitive data"
	slog.Info("to" + "ken: " + token)                 // want "log message should not contain sensitive information" "log variable name suggests sensitive data"
	...
	slog.Info("Password: " + password) // want "log message should start with lowercase letter" "log variable name suggests sensitive data" "log message should not contain sensitive information"
}
