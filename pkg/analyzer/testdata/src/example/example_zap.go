...
func testZap(logger *zap.Logger) {
	...
	logger.Info("user password: " + password) // want "log message should not contain sensitive information" "log message should not contain sensitive information"
	logger.Debug("api_key=" + apiKey)         // want "log message should not contain sensitive information" "log message should not contain sensitive information"
	logger.Info("token: " + token)            // want "log message should not contain sensitive information" "log message should not contain sensitive information"
	...
	logger.Info("Password: " + password) // want "log message should start with lowercase letter" "log message should not contain sensitive information" "log message should not contain sensitive information"
}
